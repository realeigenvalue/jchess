...
public class KnightBishop extends Piece {
	private static final Location[] KNIGHT_BISHOP_MOVES = {new Location(2, 1),   new Location(1, 2),   new Location(-1, 2),  new Location(-2, 1),
	...
	public KnightBishop(PieceColor color, Location location, boolean taken) {
	...
	public ArrayList<Location> getMoveList(ChessBoard board) {
		...
		for(Location loc : KNIGHT_BISHOP_MOVES) {
