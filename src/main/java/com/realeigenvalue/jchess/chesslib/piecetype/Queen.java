...
public class Queen extends Piece {
	private static final MoveMethod[] QUEEN_MOVES = {new MoveUp(), new MoveDown(), new MoveLeft(), new MoveRight(),
                                                     new MoveDiagNW(), new MoveDiagNE(), new MoveDiagSW(), new MoveDiagSE()};
	public Queen(PieceColor color, Location location, boolean taken) {
	...
	public ArrayList<Location> getMoveList(ChessBoard board) {
		...
		for(MoveMethod mvMethod : QUEEN_MOVES) {
